...
ダウンロードせずブラウザで試せます (要 OpenRouter API キー):

**<https://jugoya-ai.github.io/fudebako-agent/>**

ファイルのダウンロードが制限された環境やスマートフォンからも利用できます。**API 利用料・利用規約は利用者責任**です — 上記の免責事項を必ずご確認ください。
